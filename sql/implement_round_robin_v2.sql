-- ==============================================================================
-- IMPLEMENTASI ROUND ROBIN TICKET ASSIGNMENT (VERSION 2 - ROLE FILTERED)
-- ==============================================================================
...
BEGIN
    ...
    -- 2. Filter hanya Agent L1 dan Agent Supervisor (sesuai request USER).
    -- 3. Pilih yang paling lama tidak menerima tiket (least recently assigned).
    ...
    AND r.role_name IN ('Agent L1', 'Agent Supervisor') -- Hanya role ini yang dapat Round Robin
...
-- INFO: Agent L2 tidak akan menerima tiket lewat sistem ini (kecuali di-escalate manual).
